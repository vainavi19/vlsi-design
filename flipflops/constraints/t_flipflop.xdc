...
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS25} [get_ports {rst_ff}]
set_property -dict {PACKAGE_PIN F2 IOSTANDARD LVCMOS25} [get_ports {t}]
...
## On-board LEDs
set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVCMOS33} [get_ports {q}]
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS33} [get_ports {qB}]
