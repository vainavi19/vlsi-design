...
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS25} [get_ports {rst}]  
set_property -dict {PACKAGE_PIN F2 IOSTANDARD LVCMOS25} [get_ports {rst_counter}] 
#set_property -dict {PACKAGE_PIN F1 IOSTANDARD LVCMOS25} [get_ports {load}]
set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS25} [get_ports {sel[0]}]
set_property -dict {PACKAGE_PIN E1 IOSTANDARD LVCMOS25} [get_ports {sel[1]}]
...
# On-board LEDs
#set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVCMOS33} [get_ports {out_up[0]}]
#set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS33} [get_ports {out_up[1]}]
#set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports {out_up[2]}]
#set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS33} [get_ports {out_up[3]}]
